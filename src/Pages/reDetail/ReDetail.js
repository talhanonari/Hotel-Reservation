...
export default function ReDetail() {
  return (
    <div className="ReDetailsMain" id="choose">
      ...
      <div className="Dmain">
        ...
        <div className="Data_type inputmain">
          ...
          <div className="textfieldMain">
          <input type="date" id="dateInput" className="inputfeild feildproblem comments inputunik" />
        ...
        <div className="Data_type DatabotonMain">
          <Link to="/Area" className="databuttn1">
            BACK
          </Link>
          <Link to="/Confirmed" className="databuttn1">
            NEXT
          </Link>
        </div>
        <div className="ReDetailMain">
          <div className="ReDetailstab "></div>
          <div className="ReDetailstab"></div>
          <div className="ReDetailstab "></div>
          <div className="ReDetailstab fixedit"></div>
          <div className="ReDetailstab "></div>
        </div>
        <div className="Data_type ">
