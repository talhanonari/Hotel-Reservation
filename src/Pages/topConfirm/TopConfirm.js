      ...
      <div className="Confirm-main">
        ...
        <div className="Data_type inputmain">
          ...
          <div className="commentsdata">
            ...
            we’d love a cozy corner table or something with a bit of atmosphere.
            Also, one of our guests has a gluten allergy, so if you could let us
            know about any gluten-free options in advance, that would be
            amazing. We’ll also be bringing a small birthday cake (happy to pay
            a plating fee if needed). Thanks so much—we’re really looking
            forward to it!"
          </div>
        </div>
        <div className="Data_type inputmain">
